...
ancient_individuals = 4 * (sample_size + 1) + 4 * outpop_inds
...
popindexes= ["T"] * sample_size_internal + ["S1"] * sample_size_internal + ["S2"] * sample_size_internal + ["S3"] * sample_size_internal + ["O1"] * outpop_inds + ["O2"] * outpop_inds + ["O3"] * outpop_inds + ["O4"] * outpop_inds
